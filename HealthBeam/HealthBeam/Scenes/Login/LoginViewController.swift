...
extension LoginViewController {
    ...
    @IBAction func forgotPasswordButtonAction(_ sender: Any) {
        UIAlertController.presentAlertControllerWithTitleMessage("Forgotten Password".localized(), message: "Please contact your system administrator or HealthBeam's support at: support@healthbeam.io".localized(), on: self)
    }
    ...
    @IBAction func noAccountAction(_ sender: Any) {
        UIAlertController.presentAlertControllerWithTitleMessage("Don't have an account?".localized(), message: "Please contact your system administrator or HealthBeam's support at: support@healthbeam.io".localized(), on: self)
    }
}
